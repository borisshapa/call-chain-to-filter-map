/**
 * The converter of expressions described by the {@code <call-chain>} rule into expressions
 * of the form {@code <filter-call> “%>%” <map-call>}, equivalent to the original one.
 * <pre> {@code
