...
public class PolynomialTest {
    ...
    @Test
    public void constantCompose() {
        Polynomial polynomial = new Polynomial(5, 0);
        Polynomial polynomial1 = new Polynomial(1, 2).add(new Polynomial(2, 1)).add(new Polynomial(1, 0));
        valid(polynomial.compose(polynomial1).getRoots(), List.of());
    }

    @Test
    public void square() {
        Polynomial polynomial = new Polynomial(1, 2).add(new Polynomial(-4, 0));
        valid(polynomial.getRoots(), List.of(-2.0, 2.0));
    }
}
